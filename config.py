...
flags.DEFINE_integer("para_limit", 300, "Limit length for paragraph")
flags.DEFINE_integer("ques_limit", 50, "Limit length for question")
flags.DEFINE_integer("ans_limit", 30, "Limit length for answers")
flags.DEFINE_integer("test_para_limit", 300, "Limit length for paragraph in test file")
...
flags.DEFINE_integer("connector_dim", 64, "Dimension of connectors of each layer")
